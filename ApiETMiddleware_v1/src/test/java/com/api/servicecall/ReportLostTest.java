...
public class ReportLostTest {
	...
	public void setUp() throws Exception {
		 ...
		 reportLost = Mockito.mock(ReportLost.class);
	...
	@Test
	public void testReportLostImp() throws Exception {
		...
		Mockito.when(reportLost.reportLostImp(request, mockLogger)).thenReturn(res);		
