...
public class CancelLostTest {

	Logger mockLogger;
	
	CancelLost cancelLost;
	...
	public void setUp() throws Exception {
		...
		cancelLost = Mockito.mock(CancelLost.class);
	...
	@Test
	public void testCancelLostImp() throws Exception {
		...
		Mockito.when(cancelLost.cancelLostImp(request, mockLogger)).thenReturn(res);
