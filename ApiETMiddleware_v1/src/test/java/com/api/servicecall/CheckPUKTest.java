...
public class CheckPUKTest {
	...
	@Test
	public void testCheckPUKImp() throws Exception {
		
		LinkedHashMap<String,Object> request = new LinkedHashMap<>();
		request.put("ucid_id","1234567890");
		request.put("TransactionId","20220405165806");
		request.put("ServiceNumber","123555434");
		request.put("PUKCode","123456");
		
		
		CheckPUK checkPUK = new CheckPUK();
		HashMap<String, Object> res = new HashMap<>();	
		res.put("StatusCode", "200");
		res.put("StatusDescription", "Success");
				
		assertThat(checkPUK.checkPUKImp(request, mockLogger)).isEqualTo(res);
